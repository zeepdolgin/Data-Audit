...
```
From the histogram we can see that most of the rows had no violations, and 2 violations per row occured more often than either 1 or 3 violations per row.
...
Therefore, next I create a simple summary of how many rows are labeled entirely correctly vs how many rows have at lest 1 mistake:
```{r}
